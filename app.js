...
//specify the type of view engine
app.set('view engine', 'ejs')
// change the view engine folder name
// app.set('views','images')  

app.get('/', (req, res) => {
    // res.send("<h1>Home page</h1>")
    res.sendFile('./swiggy.html',{root:__dirname})
})
app.get('/ejs', (req, res) => {
    let names = [
        { name: "Chandana", img: '/1.png' },
        { name: "Anilkumar Reddy", img: '/2.png' },
        { name: "Revathi", img: '/3.png' }
    ]
    res.render('index2', { names })
})
